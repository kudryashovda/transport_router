...
public:
    Transport_router(graph::DirectedWeightedGraph<double>& routes_graph, const tc::TransportCatalogue& transport_catalogue, const Routing_settings& routing_settings)
